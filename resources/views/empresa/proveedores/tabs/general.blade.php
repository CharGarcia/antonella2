        ...
        <div class="card-body">
            <div class="row">
                @include('components.select', [
                    ...
                    'opciones' => ['04' => 'RUC', '05' => 'Cédula', '06' => 'Pasaporte', '08' => 'Exterior'],
                ...
                @include('components.select', ['nombre' => 'estado', 'label' => 'Estado', 'opciones' => ['activo' => 'Activo', 'inactivo' => 'Inactivo'], 'col' => 'col-md-4', 'mostrarPrimeraOpcion' => false])
