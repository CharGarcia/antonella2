...
@section('content_header')
    <h1>Retenciones SRI</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-between justify-content-center justify-content-md-between align-items-center gap-2 mb-3">
                <!-- Botón Mostrar filtros -->
                <button class="btn btn-outline-primary btn-sm d-flex align-items-center" id="btn-toggle-filtros">
                    <i class="fas fa-filter"></i>
                    <span class="texto-btn d-none d-md-inline ms-1"> Mostrar filtros</span>
                </button>
            ...
            <table class="table table-bordered table-striped nowrap" id="tabla-retenciones" style="width:100%;">
                <thead class="table-primary">
                    ...
                    <tr id="fila-filtros" class="filters" style="visibility: collapse;">
                        <th><input type="text" class="form-control form-control-sm" placeholder="Código" /></th>
                        <th><input type="text" class="form-control form-control-sm" placeholder="Concepto" /></th>
                        <th><input type="text" class="form-control form-control-sm" placeholder="Observaciones" /></th>
                        ...
                        <th><input type="text" class="form-control form-control-sm" placeholder="Código ATS" /></th>
                        <th>
                            <select class="form-control form-control-sm">
                                <option value="">Todos</option>
                        ...
                        <th><input type="text" class="form-control form-control-sm" placeholder="Desde" /></th>
                        <th><input type="text" class="form-control form-control-sm" placeholder="Hasta" /></th>
                        <th></th>
                    </tr>
                </thead>
            </table>
    ...
    <div class="modal fade" id="modalRetencion" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="modalRetencionLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="codigo_retencion" name="codigo_retencion" required>
              </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-10">
                ...
                <textarea class="form-control" id="concepto" name="concepto" rows="2" maxlength="500" required></textarea>
        ...
        0 / 500
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <textarea class="form-control" id="observaciones" name="observaciones" rows="1" maxlength="255"></textarea>
                  <small id="contador-observaciones" class="form-text text-muted text-right">
                    0 / 255
                </small>
                </div>
                <div class="form-group col-md-3">
...
$('#btn-nueva-retencion').on('click', function () {
    $('#modalRetencionLabel').html('<i class="fas fa-clipboard-check text-success mr-2"></i> Nueva Retención');
...
$(document).on('click', '.editar', function () {
    ...
    $.get(`/retenciones-sri/${id}`, function (data) {
        $('#modalRetencionLabel').html('<i class="fas fa-edit text-warning mr-2"></i> Editar Retención');
...
$('#tabla-retenciones thead').on('input change', '.filters input, .filters select', function () {
    tabla.ajax.reload();
});
...
$('#form-retencion').on('submit', function (e) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            Swal.fire({
                icon: 'success',
                title: id ? 'Concepto de retención actualizado' : 'Concepto de retención creado',
