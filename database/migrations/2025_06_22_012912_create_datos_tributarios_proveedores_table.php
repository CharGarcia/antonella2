...
return new class extends Migration
{
    ...
    {
        Schema::create('datos_tributarios_proveedores', function (Blueprint $table) {
            $table->id();
