    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive" style="max-height: 600px;">
                <table class="table table-bordered table-striped nowrap" id="tabla-submenus" style="width:100%;">
...
{{-- Modal subMenú --}}
    <div class="modal fade" id="modalSubmenu" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="modalSubmenuLabel" aria-hidden="true">
...
$(document).ready(function () {
    ...
    $('#tabla-submenus thead').on('input change', '.filters input, .filters select', function () {
        tabla.ajax.reload();
    });
    ...
    $('#btn-nuevo-submenu').on('click', function () {
        ...
        $('#submenu_id').val('');
        $('#modalSubmenuLabel').html('<i class="fas fa-clipboard-check text-success mr-2"></i> Nuevo SubMenú');
