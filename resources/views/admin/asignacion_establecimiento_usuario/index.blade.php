...
<div class="card">
    <div
        ...
        <h4 class="text-primary mb-0">
            ...
            Asignación de establecimientos y módulos a usuarios
        </h4>
        ...
        <form id="form-asignacion">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAsignarEstablecimientoLabel">
...
<div class="modal fade" id="modalModulos" data-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <form id="form-modulos">
            ...
            <input
                type="hidden"
                id="usuario_establecimiento_id"
                name="usuario_establecimiento_id" />
            <div class="modal-content">
...
<script>
    $(function () {
        ...
        $('#btn-nueva-asignacion').on('click', function () {
            ...
            $('#modalAsignarEstablecimientoLabel').html(
        ...
        $('#form-asignacion').submit(function (e) {
            e.preventDefault();
            $.post(
                '{{ route('asignacion_establecimiento_usuario.asignar') }}',
                $(this).serialize(),
                function (response) {
                    if (response.success) {
    ...
    `);
            ...
            $.get('/asignacion_establecimiento_usuario/permisos/' + id, function (html) {
                ...
                $('#tabla-permisos-container').html(
                    '<div class="text-danger">Error al cargar los módulos.</div>',
                );
            });
        });
