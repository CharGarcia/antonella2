        ...
        <form id="form-usuario-asignado">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUsuarioAsignadoLabel">
...
@push('js')
    <script>
        $(function () {
            ...
            $('#tabla-usuarios-asignados thead').on(
                'input change',
            ...
            $('#btn-nuevo-asignar-usuario').on('click', function () {
                ...
                $('#modalUsuarioAsignadoLabel').html(
                    '<i class="fas fa-clipboard-check text-success mr-2"></i> Asignar a un usuario un administrador',
                );
