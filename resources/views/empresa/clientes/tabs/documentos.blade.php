        ...
        <div class="card-body">
            <div class="row" id="documentos-container">
                <div class="col-md-12 mb-3">
                    <label class="form-label">Documentos del Cliente</label>
        ...
        for (let i = 0; i < input.files.length; i++) {
            ...
            div.innerHTML = `
                <div class="input-group">
                    <input type="text" name="tipos[]" class="form-control" placeholder="Tipo del documento para: ${input.files[i].name}">
