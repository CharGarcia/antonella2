...
<div class="card">
    <div
        ...
        <h4 class="text-primary mb-0">
            <i class="fas fa-vihara text-primary me-2"></i>
            Gestión de Empresas
        </h4>
...
<script>
    ...
    $(function () {
        ...
        $('#btn-nueva-empresa').on('click', function () {
            ...
            $('#empresa_id').val('');
            $('#modalEmpresaLabel').html(
                '<i class="fas fa-clipboard-check text-success mr-2"></i> Nueva empresa',
            );
        ...
        $(document).on('click', '.editar-empresa', function () {
            ...
            $.get(`/empresas/${id}`, function (data) {
                ...
                $('#modalEmpresaLabel').html(
                    '<i class="fas fa-edit text-warning mr-2"></i> Editar Empresa',
                );
                $('#modal-empresa').modal('show');
            });
        });
                    ...
                    success: function (response) {
                        ...
                        if (contribuyente) {
                            ...
                            $('#tipo_contribuyente').val(
                                contribuyente.tipoContribuyente === 'PERSONA NATURAL' ? '01' : '02',
                            );
                            $('#regimen').val(
                                obtenerRegimen(contribuyente.regimen, contribuyente.categoria),
                            );
                            $('#contabilidad').val(
                                contribuyente.obligadoLlevarContabilidad === 'SI' ? 'SI' : 'NO',
                            );
                            $('#contribuyente_especial').val(
                                contribuyente.contribuyenteEspecial === 'SI' ? 'SI' : 'NO',
                            );
                            $('#agente_retencion').val(
                                contribuyente.agenteRetencion === 'SI' ? 'SI' : 'NO',
                            );
                            $('#estado').val(
                                contribuyente.estadoContribuyenteRuc === 'activo'
                                    ? 'activo'
                                    : 'inactivo',
                            );
