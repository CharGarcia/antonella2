...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive" style="max-height: 600px;">
                <table class="table table-bordered table-striped nowrap" id="tabla-compradores" style="width:100%;">
    ...
    @include('empresa.compradores.partials.modal_comprador')
@stop

@section('js')
<script>
$(function () {
    let tabla = $('#tabla-compradores').DataTable({
