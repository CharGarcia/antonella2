...
<div class="card">
    <div
        ...
        <h4 class="text-primary mb-0">
            <i class="fas fa-clipboard text-primary me-2"></i>
            Gestión de Menús
        </h4>
...
<script>
    $(function () {
        ...
        $('#btn-nuevo-menu').on('click', function () {
            ...
            $('#menu_id').val('');
            $('#modalMenuLabel').html(
                '<i class="fas fa-clipboard-check text-success mr-2"></i> Nuevo Menú',
            );
        ...
        $(document).on('click', '.editar-menu', function () {
            ...
            $.get(`/menus/${id}`, function (data) {
                ...
                $('#modalMenuLabel').html(
                    '<i class="fas fa-edit text-warning mr-2"></i> Editar Menú',
                );
                $('#modalMenu').modal('show');
            });
        });
