...
<div class="card">
    <div
        ...
        <h4 class="text-primary mb-0">
            ...
            Permisos de roles de usuarios
        </h4>
        <div class="d-flex gap-2">
            <button
                class="btn btn-success"
                id="btn-nuevo-permiso"
                data-bs-toggle="modal"
                data-bs-target="#modalAgregarPermiso">
...
<div
    class="modal fade"
    id="modalAgregarPermiso"
    tabindex="-1"
    role="dialog"
    data-backdrop="static"
    data-keyboard="false"
    aria-labelledby="modalAgregarPermisoLabel"
    aria-hidden="true">
...
<script>
    ...
    $('#btn-nuevo-permiso').on('click', function () {
        $('#modalAgregarPermisoLabel').html(
            '<i class="fas fa-clipboard-check text-success mr-2"></i> Nuevo permiso',
        );
