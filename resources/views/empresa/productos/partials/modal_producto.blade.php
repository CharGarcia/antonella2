        ...
        <form id="form-producto">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalProductoLabel">Nuevo producto o servicio</h5>
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs mb-3" id="productoTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link"
                                id="tab-clasificacion-tab"
                                data-toggle="tab"
                                href="#tab-clasificacion"
                                role="tab">
                    ...
                    <div class="tab-content">
                        ...
                        @include('empresa.productos.tabs.comercial')
                        @include('empresa.productos.tabs.clasificacion')
                        @include('empresa.productos.tabs.contable')
                        @include('empresa.productos.tabs.produccion')
                        @include('empresa.productos.tabs.inventario')
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
                    ...
                    $('#btn-nuevo-producto').on('click', function () {
                        ...
                        $('#producto_id').val('');
                        $('#modalProductoLabel').html('<i class="fas fa-clipboard-check text-success mr-2"></i> Nuevo Producto o Servicio');
                        const hoy = new Date();
